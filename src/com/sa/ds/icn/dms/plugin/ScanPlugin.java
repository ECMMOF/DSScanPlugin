package com.sa.ds.icn.dms.plugin;
...
public class ScanPlugin extends Plugin {
	...
	public String getName(Locale locale) {
		//return "\u0645\u0633\u0627\u0639\u062F \u0627\u0644\u0645\u0633\u062D \u0627\u0644\u0636\u0648\u0626\u064A";
		
		if(locale.toString().toLowerCase().startsWith("ar"))
			return "DMS Scan Plugin";
		else
			return "DMS Scan Plugin";
	}
...
//		return "ScanPluginV1.js.jgz";
		return "ScanPlugin.js";
	}
...
//		return "ScanPluginV1.css.jgz";
		return "ScanPlugin.css";
	}
	...
	public PluginResponseFilter[] getResponseFilters() {
		return new PluginResponseFilter[] {
				new com.sa.ds.icn.dms.plugin.filters.AddFilesToFolder(), 
	...
	public String getConfigurationDijitClass() {
		return "scanPluginDojo.ConfigurationPane";
	}
	...
	public com.ibm.ecm.extension.PluginAction[] getActions() {
		return new com.ibm.ecm.extension.PluginAction[]{new com.sa.ds.icn.dms.plugin.actions.ScanDocument(), new com.sa.ds.icn.dms.plugin.actions.ScanDocumentUsingTemplate(), new com.sa.ds.icn.dms.plugin.actions.ScanCheckin(),new com.sa.ds.icn.dms.plugin.actions.AddContentItemCustomDialog() };
	}
