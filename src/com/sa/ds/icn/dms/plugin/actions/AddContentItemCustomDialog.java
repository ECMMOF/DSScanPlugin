 ...
 */
public class AddContentItemCustomDialog extends PluginAction {
	 ...
	 */
	public String getId() {
		return "DMSAddContentItemCustomDialog";
	}
	...
	public String getActionFunction() {
		return "addContentItemCustomDialog";
	}
